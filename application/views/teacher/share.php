<div id="content" class="main box container-fluid">
    <div class="row-fluid">
	  ...
	  <div id="maincontent" class="span9">
		...
		<!-- 上传pub，老师、助教要 -->
		<a href="#myModalx2" role="button" class="btn btn-primary btn-lg" data-toggle="modal">上传公共资源</a>
		<div id="myModalx2" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				<h3 id="myModalLabel">上传公共资源</h3>
			</div>
			
			<form action="/sestudy/index.php/share/up_pub" method="post" enctype="multipart/form-data">
				&nbsp&nbsp&nbsp&nbsp<input type="file" name="upfile">
			...
			<tr>
			  ...
			  <td><a href="#myModalmy<?=$key?>" data-toggle="modal"><i class="icon-refresh"></i></a></td>
				...
				<select class="form-control" id="choose" name="choose">
					<option value= 1>上传至本课程</option>
					<option value= 2>上传至公共资源</option>
				</select>
		...
		<legend><strong>我的公共资源</strong></legend>
        ...
        <table align="center" class="table table-hover" style="border-left: 1px solid #dddddd;border-right: 1px solid #dddddd;border-bottom: 1px solid #dddddd;border-collapse: separate;-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;">
          <tbody>
			...
			<tr>
			  ...
			  <td style="text-align:center"><?=$data[$key]->uploaddate?></td>
			  <td style="text-align:center"><?=$data[$key]->downcount?></td>
			  <td><a href="#myModalmypub<?=$key?>" data-toggle="modal"><i class="icon-refresh"></i></a></td>
				
				
				<div id="myModalmypub<?=$key?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				  <div class="modal-header">
				    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					<h3 id="myModalLabel">重上传</h3>
				  </div>
			  ...
			  <td><a href="#my2Modalmypub<?=$key?>" data-toggle="modal"><i class="icon-download-alt"></i></a></td>
				<div id="my2Modalmypub<?=$key?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
						<h3 id="myModalLabel"><?=$data[$key]->filename_see?></h3>
					</div>
