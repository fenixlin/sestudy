  <div id="content" class="main box container-fluid">
    <div class="row-fluid">
      <div id="sidecontent" class="span3">
        <div id="sidebar">
          <ul class="nav nav-list">
            ...
            <li class="active"><a href="<?=site_url()?>upload.html">资料下载</a></li>
	  ...
	  <?php $data = $this->recourse_model->see_stu_class($courseid);?>
	  <?php $classid = $data[0] ->classid;?>
	  <?php $data = $this->recourse_model->see_class_upload($classid);?>
	  <?php //echo $classid ;?>
