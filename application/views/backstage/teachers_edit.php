  ...
  <div class="container">
    <div id="internal_container">
        ...
        ?> 
          ...
          ?>
          <?php $userinfo = $this->backstage_model->get_teacher_info($userid); ?>
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    foreach ($query->result() as $row)
                    {
                      ...
                      if ($this->backstage_model->is_teaching($userid, $row->courseid, $row->classid)) echo "checked></td>";                     
                        else echo "></td>";
