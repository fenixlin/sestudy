<body>  
  ...
  <div class="container">
    <div id="internal_container">
    	<legend>
        <strong>添加教师账户</strong>
        <a class="btn" style="float:right;" href="<?=site_url()?>backstage/teachers.html">返回</a>
      </legend>
        <?php 
          $attr = array('class'=>'form-horizontal');
          echo form_open('backstage/teachers_new',$attr);
        ?> 
          <?php
          ...
          ?>
            ...
            <div class="controls">
              <input class="input-xlarge" type="text" id="username" name="username" value="">
            </div>
          </div>
          <div class="control-group">
            <label class="control-label" for="name">姓名&nbsp;:</label>
            <div class="controls">
              <input class="input-xlarge" type="text" id="name" name="name" value="">
            </div>
          </div>
          <div class="control-group">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input class="input-xlarge" type="text" id="email" name="email" value="">
            </div>
          </div>
          <div class="control-group">
            <label class="control-label" for="tel">联系电话&nbsp;:</label>
            <div class="controls">
              <input class="input-xlarge" type="text" id="tel" name="tel" value="">
            </div>
          </div>
          <div class="control-group">
            <label class="control-label" for="tel">执教班级&nbsp;:</label>
            <div class="controls">
