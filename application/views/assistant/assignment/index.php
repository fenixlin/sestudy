    ...
    <div id="maincontent" class="span9">
      ...
      <table class="table table-hover">
        <tbody>
          ...
          $query = $this->assignment_model->get_assistant_class_list($userid, $courseid);
          $flag = FALSE;
          foreach ($query->result() as $row)
          {
            ...
            $tchlist = $this->assignment_model->get_class_teacher($courseid, $row->classid);              
            echo "<td>";
            ...
            echo "<td><a class=\"btn btn-primary\" href=\"".site_url()."assignment\\operate\\".$row->classid."\">选择</i></a>";              
