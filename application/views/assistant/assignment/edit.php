  <div id="content" class="main box container-fluid">
    <div class="row-fluid">
      ...
      <div id="maincontent" class="span9">
       ...
       $query = $this->assignment_model->get_homework($classid, $courseid, $number);
       foreach ($query->result() as $row) {
       ?>
       <div><h3>题目</h3></div>
       <input class="input-block-level" type="text" id="title" name="title" value="<?php echo $row->title; ?>">
       <div><h3>要求</h3></div>
       <textarea style="width:100%;height:200px;" id="requirement" name="requirement"><?php echo $row->requirement;} ?></textarea>
